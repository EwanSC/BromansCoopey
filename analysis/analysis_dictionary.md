...
* Values: Unconstrained vocabulary: All values are distinct. While there may be duplicate names, they are names shared by individual people. Use ServicemanID to determine uniqueness.
4. **Tribus**
...
* Values: Constrained vocabulary: _null_; Aemilia; Aniensis; Camilia; Claudia; Cornelia; Fabia; Lemonia; Maecia; Palatina; Papiria; Pollia; Pomptina; Publilia; Quirina; Scaptia; Sergia; Tromentia; Velina; Voltinia
5. **Domicilium**
...
* Values: Constrained vocabulary. yes; maybe
...
* Values: Constrained vocabulary: _null_; exacto consularis(epigraphically attested); iudex(epigraphically attested); praefectus castorum(epigraphically attested)
...
* Values: Constrained vocabulary: _null_; veteranus(conjecture); veteranus(epigraphically attested)
11. **ServicemanNote**
...
* Values: Textual description: This column has 38 distinct values including _null_. These notes consist of paragraphs or sentences.
...
* Values: Unconstrained: Each value is _null_ or distinct. If distinct, in the format of: "'Volume' , 'Reference number'". E.g. 03, 14951 is inscription #14951 in the 3rd volume of the CIL (often recorded as III 14951).
3. **Tončinić**
* Source Table: (data/monument_corpus.CorpusName & data/monument_corpus.Reference)
...
* Values: Unconstrained: All values are distinct or _null_. If distinct, in format of: "'Volume', 'Reference number'". E.g. 3, 2092 is inscription 2092 in the 3rd volume of ILJug.
6. **AE**
* Source Table: (data/monument_corpus.CorpusName & data/monument_corpus.Reference)
...
* Values: Unconstrained: All values are distinct or _null_. If distinct, in format of: "'Year of AE', 'Reference number'". E.g. 1900, 0046 is inscription 46 from the AE volume published for the year 1900.
7. **EDCS**
* Source Table: (data/monument_corpus.CorpusName & data/monument_corpus.Reference)
...
* Values: Unconstrained: All values are distinct or _null_. If distinct, they comprise of a URL to the monument on the EDCS website. The last **8** numerals of each URL are also the monuments EDCS identification number. E.g. http://db.edcs.eu/epigr/edcs_id.php?s_sprache=en&p_edcs_id=EDCS-28400134 = EDCS ID 8400134.
8. **EDH**
* Source Table: (data/monument_corpus.CorpusName & data/monument_corpus.Reference)
...
* Values: Unconstrained: All values are distinct or _null_. If distinct, they comprise of a URL to the monument on the EDH website. The last **8** characters of each URL are also the monuments EDH identification number. E.g. https://edh-www.adw.uni-heidelberg.de/edh/inschrift/HD028366 = EDH ID HD028366.
9. **OtherRef**
* Source Table: (data/monument_corpus.CorpusName & data/monument_corpus.Reference)
...
* Values: Unconstrained: The values are either _null_ or a citation in author date format [Chicago](https://libguides.mq.edu.au/referencing/Chicago). E.g. Wilkes 1969, 461; Maršić 2010, 65-67.
...
* Values: Unconstrained: Each value is a distinct citation. Either in the form of "'Reference work abbreviation', 'Volume', 'Reference number'" for a reference work, or author date (Chicago) for non reference works.
...
* Values: Constrained vocabulary: titulus; stela; sacral monument; inscription fragment; funerary inscription; altar
5. **Creation_Date**
...
* Values: Numerical: The dates range between -30 and 230
6. **Site_of_Discovery**
...
* Values: Textual description: Each value is a distinct transliteration.
8. **Media**
...
* Values: Unconstrained: _null_ or distinct. Distinct values are all URLs to gallery of images.  
...
* Records the class of archaeological / epigraphic monument. The definitions for the types of monument are as follows:
  ...
  * 'altar' = a sacrificial altar with a funerary inscription.
* Values: Constrained vocabulary (see above): titulus; tegula; stela; sacral monument; sacral altar; milestone; inscription fragment; funerary inscription; construction dedication; boundary inscription; altar.
4. **Mention_Legio_VII**
* Source Table: (data/monument.MonumentOfSeventhLegion)
...
* Values: Constrained vocabulary: yes, maybe, no
5. **Inscription**
* Source Table: (data/monument.inscription)
* Records a transcription of the inscription found upon each monument in the original Latin or, rarely, ancient Greek, following the [Leiden Conventions](https://en.wikipedia.org/wiki/Leiden_Conventions).
* Values: Textual description: Each value is a distinct transliteration of an inscription.
6. **Translation**
...
* Values: Constrained vocabulary (see above): _null_; Tončinić 2011; Demicheli, Tončinić 2012; Coopey, edit of Tončinić 2011 and Cesarik 2016; Coopey, edit of Tončinić 2011 (made with help of Milićević-Bradač); Coopey, edit of Tončinić 2011; Coopey, edit of Rendić-Miočević 1987; Coopey
...
* Values: Constrained vocabulary from Tončinić (2011). _null_; A1a; A1b; A2; A3a; A3b; A3c; Ra; Rb; Rc; altar; tituli
...
* Values: Constrained vocabulary (own): _null_; bust; bust and rider; dual bust; family bust; no portrait; rider
11. **Frieze**
...
* Values: Constrained vocabulary (own):_null_; floral; military; no frieze.
12. **Creation_Date**
* Source Table: (data/monument.DateFrom & data/monument.DateTo)
...
* Values: Numerical: dates range between -30 and 230
13. **DateNote**
...
* Values: Textual description: Values are distinct (sentences or more specific ranges) or _null_
14. **Current_Location**
...
* Records the Roman province wherein the monument was found (see data/data_dictionary for source of vocabulary)
* Values: Constrained vocabulary: Dalmatia; Galatia; Moesia Superior; Thracia
16. **Ancient_Site**
...
* Values: Constrained vocabulary from https://www.trismegistos.org where possible, otherwise see analysis/all_corpora. _null_; Aequum; Andetrium; Antiochia Pisidiae; Apollonia/Tymandus; Asseria; Burnum; Corinium; Cormasa; Iadera; Iconium; Lysimacheia; Municipium Riditarum/Rider; Narona; Pagus Scunasticus; Pons Tiluri; Salona; Siculi; Spalatum; Tilurium; Tragurium; Viminacium
...
* Values: Textual description: _null_; Cetina River; Church of st Michael; Mausoleum of Diocletian; built into modern structure; carved into rock; part of c.4th Late Antique tomb; re-used in Christian Cemetery; re-used in Medieval Cemetery; secondary use; surrounds of the amphitheatre; ul. Marka Marulića; uncertain
...
* Values: Textual description: each value is either _null_ or a piece/pieces of information distinct to each monument.
22. **LAT**
...
* Values: Numerical: 56 DISTINCT LAT values including _null_
23. **LONG**
...
* Values: Numerical: 56 DISTINCT LONG values including _null_
24. **Pleiades**
...
* Values: URL: 22 DISTINCT Pleiades values including _null_
25. **Trismegistos**
...
* Values: URL: 30 DISTINCT Trismegistos values including _null_
26. **MonumentNote**
...
* Values: Textual description: 54 DISTINCT MonumentNote values including _null_
...
* Values: Textual description: 21 DISTINCT DBInclusionReason values including _null_
28. **Media**
* Source Table: (data/monument.Media)
* Records URLs for images (photos or illustrations) of the monument. Where possible, the URL is for the <http://lupa.at> website. With some monuments having links to EDCS <http://db.edcs.eu>, and some having no images within the database (represented with _null_)
* Values: URL: _null_ or distinct. Distinct values are all URLs to gallery of images.  
